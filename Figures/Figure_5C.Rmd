...
# Here I am using data from table S8 that has specific marker genes for these tissue types
files.dir2<-"~/Dropbox/Postdoc/2019-12-29_BE2020/Figures/Supplemental_tables/"


#load workbook with marker genes
tmp<-loadWorkbook(paste0(files.dir2, "Table_S8.xlsx"))
...
markers[["Endocrine"]]<-read.xlsx(loadWorkbook(paste0(files.dir2, "Table_S6_2.xlsx")), sheet = "Endocrine_NEUROG3")
...
markers[["Goblet"]]<-read.xlsx(loadWorkbook(paste0(files.dir2, "Table_S6_2.xlsx")), sheet = "Goblet")
