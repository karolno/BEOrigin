...
directory<-paste0(opt$out,"/", tumourname, "_vs_", normalname, "_refit")
# directory<-paste0("/mnt/data/Karol/BE_origin/Newest/battenberg/out/","/", tumourname, "_vs_", normalname, "_refit")
