...
#main function
CIBERSORT <- function(sig_matrix, mixture_file, perm=0, QN=TRUE, absolute=FALSE, abs_method='sig.score', location = './'){
    ...
    #save results
    write.table(rbind(header,output), file=paste0(location,"CIBERSORT-Results.txt"), sep="\t", row.names=F, col.names=F, quote=F)
